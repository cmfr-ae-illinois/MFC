...
def _load():
    ...
    # volume filtering
    for n in ["volume_filter_momentum_eqn", "slab_domain_decomposition", "q_filtered_wrt"]:
        _r(n, LOG)
    _r("t_step_start_stats", INT)
    _r("volume_filter_width", REAL)
