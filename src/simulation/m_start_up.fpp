...
contains
    ...
    impure subroutine s_read_input_file
        ...
        Ca, Web, Re_inv, acoustic_source, acoustic, num_source, polytropic, thermal, integral, integral_wrt, num_integrals, &
            ...
            & compute_particle_drag, u_inf_ref, rho_inf_ref, P_inf_ref, periodic_forcing, mom_f_idx, forcing_window, forcing_dt, &
            & forcing_wrt, fluid_volume_fraction, volume_filter_momentum_eqn, slab_domain_decomposition, t_step_start_stats, &
