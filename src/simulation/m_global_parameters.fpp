...
contains
    ...
    impure subroutine s_initialize_global_parameters_module
        ...
        if (q_filtered_wrt) then
            ...
            volume_filter_dt%stat_size = 1 + 4*(2*6 + num_dims + eqn_idx%E + 1)
            ...
            volume_filter_dt%stat_pres_idx = 2 + 4*(2*6 + num_dims + eqn_idx%E)
        end if
        ...
        $:GPU_UPDATE(device='[volume_filter_width]')
